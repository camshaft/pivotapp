...
stage : rel
	$(foreach dep,$(wildcard deps/* wildcard apps/*), rm -rf rel/pivotapp/lib/$(shell basename $(dep))-* && ln -sf $(abspath $(dep)) rel/pivotapp/lib;)
...
COMBO_PLT = $(HOME)/.pivotapp_combo_dialyzer_plt
